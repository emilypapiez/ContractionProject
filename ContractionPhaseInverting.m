addpath("/Volumes/Emily_Project/Data/Sample Data")
...
SamplesB = {'Binary_6_2_1_2','Binary_6_2_1_3','Binary_6_2_1_4', 'Binary_6_2_1_5','Binary_6_2_1_6','Binary_6_2_1_7','Binary_6_2_1_8','Binary_6_2_1_9','Binary_6_2_1_10','Binary_6_2_1_11','Binary_6_2_1_12','Binary_6_2_1_13','Binary_6_2_1_14','Binary_6_2_1_15','Binary_6_2_1_16','Binary_6_2_1_18','Binary_6_2_1_20';
...
SamplesP = {'Phase_6_2_1_2','Phase_6_2_1_3','Phase_6_2_1_4','Phase_6_2_1_5','Phase_6_2_1_6','Phase_6_2_1_7','Phase_6_2_1_8','Phase_6_2_1_9','Phase_6_2_1_10','Phase_6_2_1_11','Phase_6_2_1_12','Phase_6_2_1_13','Phase_6_2_1_14','Phase_6_2_1_15','Phase_6_2_1_16','Phase_6_2_1_18','Phase_6_2_1_20';
...
r = 214.245; % set the radius of the peg, specific to image size
rROI = 465.1512; %set the radius of the center circle
white = 519996510; %set the number of pixels in the center circle by measuring the value of the circle on a white image 
...
for n = 1:1 %For Loop to go through sample numbers position (in the array) first : last
    for i= 9:9 %Loop to go through days in vitro position (in the array) first : last
...
pegs = 4; %set the number of pegs - should stay at 4 
...
p1 = drawline('Position', [rpeg(1,:);rpeg(3,:)]); %draws line between pegs 1 and 3
p2 = drawline('Position', [rpeg(2,:);rpeg(4,:)]);%draws line between pegs 2 and 4

xp1 = [rpeg(1,1),rpeg(3,1)];
yp1 = [rpeg(1,2),rpeg(3,2)];
xp2 = [rpeg(2,1),rpeg(4,1)];
yp2 = [rpeg(2,2),rpeg(4,2)];

[xi, yi]= polyxpoly(xp1, yp1, xp2, yp2);
